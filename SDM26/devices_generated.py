...
def configure_devices(devices: List[device_data]) -> None:
    ...
    for device in devices:
        match device.name:
            ...
            case "IMU_GYRO_X":
                device.signed = True
                device.conversion_factor = lambda v: (v * 17.5) / 1000
                device.units = "deg/s"
